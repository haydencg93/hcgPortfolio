...
def readConfig(cfile):
    ...
    return(config)
#print(readConfig('covid19Simulator.cfg'))
#print(newPop(readConfig('covid19Simulator.cfg')))

######################################################################
# Specification: sim(cfile='covid19Simulator.cfg') returns a list of integers,
...
#     .  . |===================||====| .   <= days
#
def sim(cfile='covid19Simulator.cfg'):
    ...
    return(curve)
print(sim(cfile='covid19Simulator.cfg'))